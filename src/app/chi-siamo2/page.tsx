...
const stats = [
  { label: 'AL1, AL2, AL3', value: '3 gruppi' },
  { label: 'Lupetti, Esploratori, Guide, Rover e Scolte', value: '200+ ragazzi' },
  { label: 'Ore di attività all’anno', value: '1000' },
]
  ...
  return (
    <>
      <Layout>
        ...
        {/* Values section */}
        <div className="mx-auto mt-32 max-w-7xl px-6 pb-6 sm:mt-40 lg:px-8 mb-8">

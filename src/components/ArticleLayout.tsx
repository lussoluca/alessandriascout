          ...
          <article>
            <header className="flex flex-col">
              <Link href="/blog">
                <div
                  aria-hidden="true"
                  className="text-scouting-purple relative z-10 mt-4 flex items-center text-sm font-medium"
                >
                  Torna al blog
                  <svg
                    viewBox="0 0 16 16"
              ...
              <h1 className="text-ocean-blue mb-6 text-4xl font-bold tracking-tight sm:text-5xl">
                {meta.title}
              </h1>
            ...
            <Prose className="my-8">
              {documentToReactComponents(
                meta.content.json,
                renderOptions(meta.content.links),
              )}
            </Prose>

        ...
        <div className="mx-auto max-w-2xl py-8 sm:py-8">
          <div className="text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Benvenuta/o sul sito dello scoutismo alessandrino, promosso dai Gruppi AGESCI cittadini (AL1, AL2, AL3), dalla Comunità del Movimento Adulti Scout Cattolici Italiani (MASCI) e dagli Amici degli Scout di Alessandria.
            </p>

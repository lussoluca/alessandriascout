export function Quote() {
    return (
        <section className="hidden lg:block relative isolate overflow-hidden bg-white px-6 lg:px-8 p-6">
            <div className="mx-auto max-w-2xl lg:max-w-4xl">
                <figure className="mt-10">
                    <blockquote
                        className="text-center text-sm font-semibold leading-8 text-gray-900 sm:text-xl sm:leading-9">
                        <p>
                            ...
                            <br/>Mantenete la vostra promessa di esploratori anche quando non sarete più ragazzi e Dio
                            vi aiuti in questo.&quot;
                        </p>
                    </blockquote>
